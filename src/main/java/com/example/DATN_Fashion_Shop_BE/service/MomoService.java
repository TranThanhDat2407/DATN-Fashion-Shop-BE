...
public class MomoService {
    ...
    // Cấu hình trực tiếp trong service
    private static final String PARTNER_CODE = "MOMO";
    private static final String ACCESS_KEY = "F8BBA842ECF85";
    private static final String SECRET_KEY = "K951B6PE1waDMi640xX08PD3vg6EkVlz";
    private static final String API_URL = "https://test-payment.momo.vn/v2/gateway/api";
    private static final String RETURN_URL = "http://localhost:4200/client/vnd/vi/momo-success";
    private static final String IPN_URL = "http://localhost:8080/api/v1/momo/callback";
    ...
    public Map<String, Object> createPayment(long amount, String orderInfo, String baseOrderId) {
        try {
            ...
            System.out.println("🔹 API Response: " + new ObjectMapper().writeValueAsString(response));
